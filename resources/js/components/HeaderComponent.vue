...
<div>
    <nav class="bg-white shadow-sm fixed-top">
        <div class="py-2 pe-1 pe-sm-4"><!--px-1 px-sm-4-->
            <div class="row g-0">
    ...
    <create-publication-component></create-publication-component>
</div>
</template>
<script>
import CreatePublicationComponent from './CreatePublicationComponent.vue';
export default {
    components: {
